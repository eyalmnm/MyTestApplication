...
import tests.em_projects.com.mytestapplication.utils.TimeUtils;
...
public class ApiCameraActivity extends Activity {
    ...
    OnClickListener cancelListener = new OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            ApiCameraActivity.this.setResult(Activity.RESULT_OK, intent);
    ...
    OnClickListener flashToggleListener = new OnClickListener() {
        ...
        public void onClick(View view) {
            flashToggle.setImageResource(mPreview.isTurnOnFlash() ?
                    R.drawable.ic_flash_auto_white_18dp : R.drawable.ic_flash_off_white_18dp);
